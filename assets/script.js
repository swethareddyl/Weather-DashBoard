...
var apiKey = " bb4c77e33a3ebf7e0c8f2ae9515bb89b";
...
searchButton.click(function () {
    ...
    var urlCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + searchInput + "&Appid=" + ce68386d5bd7c8e9e3430f0e0a1e2b66 + "&units=imperial";
    // Variable for 5 day forecast working
    var urlFiveDay = "https://api.openweathermap.org/data/2.5/forecast?q=" + searchInput + "&Appid=" + ce68386d5bd7c8e9e3430f0e0a1e2b66  + "&units=imperial";
    if (searchInput == "") {
